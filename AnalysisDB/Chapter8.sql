...
-- Changes query's search method and makes it faster to execute

COPY pls_fy2014_pupld14a FROM 'C:\Users\User\Documents\Analysis_PostgreSQL\AnalysisDB\pls_fy2014_pupld14a.csv' WITH (FORMAT CSV, HEADER);
...
COPY pls_fy2009_pupld09a FROM 'C:\Users\User\Documents\Analysis_PostgreSQL\AnalysisDB\pls_fy2009_pupld09a.csv' WITH (FORMAT CSV, HEADER);
...
FROM pls_fy2014_pupld14a
GROUP BY libname --the number of times that the duplicate names appears
...
FROM pls_fy2014_pupld14a;
-- if min value return -x, signifies a key/code
...
SELECT stabr
FROM pls_fy2014_pupld14a
GROUP BY stabr --no need to input distinct since group by appears
ORDER BY stabr;
...
FROM pls_fy2014_pupld14a
GROUP BY city, stabr -- looks at distinct values, combo appears x times on the table
ORDER BY count(*) DESC;
...
FROM pls_fy2014_pupld14a AS pls14 JOIN pls_fy2009_pupld09a AS pls09 -- aliases set first pls_fy2014_pupld14a pls14
